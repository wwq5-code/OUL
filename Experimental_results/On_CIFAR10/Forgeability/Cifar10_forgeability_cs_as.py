...
OUL = [0.959056, 0.9590567, 0.9590779, 0.95921, 0.95937, 0.95940212]
...
my_y_ticks = np.arange(0.95, 0.97, 0.004)
...
plt.savefig('cifar10_forgeability_cs_as.pdf', format='pdf', dpi=200)
plt.show()