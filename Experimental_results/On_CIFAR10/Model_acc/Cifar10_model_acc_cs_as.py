...
OUL = [0.7654, 0.7686, 0.7558, 0.7577, 0.7614]

org_acc = [0.7924, 0.7985, 0.7831, 0.7835, 0.7741 ]

vbu_acc = [0.7869, 0.7869, 0.7869, 0.7869, 0.7869, 0.7869]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
Shadow_m = [0.3755, 0.4380, 0.4854, 0.5153, 0.5343]
...
plt.legend(loc=(0.05, 0.05),fontsize=20)
plt.tight_layout()
#plt.title("MNIST")
