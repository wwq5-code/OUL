...
OUL = [0.7389, 0.7391, 0.7429, 0.7485, 0.7519, 0.7548]

org_acc = [0.7890,  0.7890, 0.7890, 0.7890, 0.7890, 0.7890]

vbu_acc = [0.4323, 0.4323, 0.4323, 0.4323, 0.4323, 0.4323]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.2964, 0.2964, 0.2964, 0.2964, 0.2964, 0.2964]
...
plt.savefig('cifar10_model_acc_cs_as.pdf', format='pdf', dpi=200)
plt.show()