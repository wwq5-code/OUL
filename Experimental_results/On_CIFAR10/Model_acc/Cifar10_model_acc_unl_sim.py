...
OUL = [0.7724, 0.7484, 0.7651, 0.7435, 0.7389]

org_acc = [0.7869,  0.7888, 0.7997, 0.7912, 0.7890]

vbu_acc = [0.5498, 0.5464, 0.4733, 0.3997, 0.4323]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.2672, 0.2840, 0.2884, 0.2115, 0.2964]
...
plt.savefig('cifar10_model_acc_unl_sim.pdf', format='pdf', dpi=200)
plt.show()