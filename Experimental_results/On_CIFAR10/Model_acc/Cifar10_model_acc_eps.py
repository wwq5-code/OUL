...
OUL = [0.7521, 0.7484, 0.7468, 0.7579,  0.7523,  0.75723]

org_acc = [0.7926, 0.7926, 0.7926, 0.7926, 0.7926, 0.7926]

vbu_acc = [0.2347, 0.2347,  0.2347, 0.2347, 0.2347, 0.2347]
...
plt.savefig('cifar10_model_acc_eps.pdf', format='pdf', dpi=200)
plt.show()