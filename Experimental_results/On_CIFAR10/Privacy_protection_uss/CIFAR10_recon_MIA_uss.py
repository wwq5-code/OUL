...
OUL = [0.5000, 0.5000 , 0.5013, 0.5008, 0.5008]

OUbLi_w = [0.5870, 0.5840, 0.5793, 0.5817, 0.5728]

bfu_acc = [0.6510, 0.6315, 0.6043, 0.6212, 0.6176]
...
my_y_ticks = np.arange(0.4, 0.81, 0.1)
...
plt.savefig('CIFAR10_recon_mia_uss.pdf', format='pdf', dpi=200)
plt.show()