...
OUL = [0.84049, 0.861497, 0.86411, 0.86400, 0.8694]

OUbLi_w = [0.942418, 0.90927, 0.9009611689, 0.8949, 0.8924]

bfu_acc = [0.9493068, 0.93015, 0.9059871, 0.900625, 0.8946490]
...
plt.savefig('CIFAR10_recon_sim_uss.pdf', format='pdf', dpi=200)
plt.show()