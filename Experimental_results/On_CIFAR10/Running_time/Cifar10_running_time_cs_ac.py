...
OUL = [7.0010, 11.4891, 16.10273, 20.64082, 25.13093, 30.13093]

org_acc = [455.59788, 448.46899, 435.2018, 427.312, 412.5165, 402.5165]
...
plt.savefig('cifar10_running_time_cs_as.pdf', format='pdf', dpi=200)
plt.show()