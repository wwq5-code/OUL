...
OUL = [0.87774, 0.87839, 0.87784, 0.87630911, 0.87385]

org_acc = [0.9999, 0.9999, 0.9999, 0.9999, 0.9999]
vbu_acc = [0.9999, 0.9999, 0.9999, 0.9999, 0.9999]
#vbu_acc = [0.87675, 0.87731, 0.876866, 0.87529331, 0.87280]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]

vbu_ldp_acc = [0.96718, 0.967492, 0.96787, 0.96831, 0.9688180]
...
plt.savefig('cifar10_recon_sim_unl_sim.pdf', format='pdf', dpi=200)
plt.show()