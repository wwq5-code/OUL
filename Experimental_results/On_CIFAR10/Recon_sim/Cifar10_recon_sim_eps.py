...
OUL = [0.873668, 0.87366, 0.87368, 0.873666, 0.873673, 0.873673]

org_acc = [0.9958, 0.9975, 0.9983, 0.9967, 0.9942, 0.9972]

vbu_acc = [0.8740634, 0.87406, 0.874063,0.874063, 0.874063, 0.874063]
...
my_y_ticks = np.arange(0.872, 0.876, 0.001)
...
plt.savefig('cifar10_recon_sim_eps.pdf', format='pdf', dpi=200)
plt.show()