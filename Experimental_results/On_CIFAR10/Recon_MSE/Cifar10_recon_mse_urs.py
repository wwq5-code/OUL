...
OUL = [0.073976, 0.073875, 0.07434, 0.074182, 0.073813, 0.073813]

org_acc = [0.9958, 0.9975, 0.9983, 0.9967, 0.9942, 0.9972]

vbu_acc = [0.073560, 0.07402, 0.074445, 0.07420526, 0.0736792, 0.0736792]
...
plt.ylabel('Reconstruction MSE' ,fontsize=24)
my_y_ticks = np.arange(7.32, 7.44, 0.02)
plt.yticks(my_y_ticks,fontsize=20)
plt.xlabel('Unl. Request Size Ratio' ,fontsize=20)

plt.xticks(x, labels, fontsize=20)
# plt.title('CIFAR10 IID')

plt.annotate(r"1e-2", xy=(0.1, 1.01), xycoords='axes fraction', xytext=(-10, 10), textcoords='offset points', ha='right', va='center', fontsize=15)
...
plt.savefig('cifar10_recon_mse_urs.pdf', format='pdf', dpi=200)
plt.show()