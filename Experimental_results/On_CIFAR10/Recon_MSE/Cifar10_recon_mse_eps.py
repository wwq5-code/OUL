...
OUL = [0.073876, 0.07387, 0.0738682, 0.073878, 0.073873, 0.073873]

org_acc = [0.9958, 0.9975, 0.9983, 0.9967, 0.9942, 0.9972]

vbu_acc = [0.074025, 0.0740258, 0.0740258, 0.0740258, 0.0740258, 0.0740258]
...
my_y_ticks = np.arange(7.36, 7.46, 0.02)
...
plt.savefig('cifar10_recon_mse_eps.pdf', format='pdf', dpi=200)
plt.show()