...
OUL = [0.07386, 0.073875, 0.07392, 0.073961, 0.073603, 0.073503]

org_acc = [0.9958, 0.9975, 0.9983, 0.9967, 0.9942, 0.9972]

vbu_acc = [0.073678, 0.074025, 0.073869787, 0.074047, 0.073575, 0.073475]
...
my_y_ticks = np.arange(0.7, 0.8, 0.02)
...
plt.savefig('cifar10_recon_mse_cs_as.pdf', format='pdf', dpi=200)
plt.show()