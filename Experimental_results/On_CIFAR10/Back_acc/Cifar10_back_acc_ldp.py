...
OUL = [0.0940, 0.0940, 0.0940, 0.0940, 0.0940]

org_acc = [0.9940, 0.9920, 0.9940, 0.9940, 0.9920]

bfu_acc = [0.097, 0.097, 0.097, 0.097, 0.097]
...
plt.savefig('cifar10_back_acc_ldp.pdf', format='pdf', dpi=200)
plt.show()