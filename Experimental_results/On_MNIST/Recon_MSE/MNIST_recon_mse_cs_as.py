...
OUL = [ 0.02096, 0.02135, 0.02169, 0.021888, 0.02218, 0.02288]

org_acc = [0.9958, 0.9975, 0.9983, 0.9967, 0.9942, 0.9972]

vbu_acc = [0.02059, 0.02101, 0.02157, 0.0215751, 0.02205, 0.02211]
...
plt.savefig('mnist_recon_mse_cs_as.pdf', format='pdf', dpi=200)
plt.show()