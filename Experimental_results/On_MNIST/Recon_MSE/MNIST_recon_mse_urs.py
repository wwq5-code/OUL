...
OUL = [0.02486, 0.02126, 0.02023627, 0.01944, 0.019519936, 0.019413]

org_acc = [0.9958, 0.9975, 0.9983, 0.9967, 0.9942, 0.9972]

vbu_acc = [0.024868, 0.02131339, 0.020363, 0.019658, 0.0193561, 0.0196456]
...
my_y_ticks = np.arange(1.8, 2.8, 0.2)
plt.yticks(my_y_ticks,fontsize=20)
plt.xlabel('Unl. Request Size' ,fontsize=20)
...
plt.savefig('mnist_recon_mse_urs.pdf', format='pdf', dpi=200)
plt.show()