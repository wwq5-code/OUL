...
OUL = [0.021259, 0.02135, 0.0211882383, 0.021137638, 0.02117106, 0.02117106]

org_acc = [0.9958, 0.9975, 0.9983, 0.9967, 0.9942, 0.9972]

vbu_acc = [0.02101, 0.02101, 0.02101, 0.02101, 0.02101, 0.02101]
...
my_y_ticks = np.arange(2.0, 2.2, 0.04)
...
plt.savefig('mnist_recon_mse_eps.pdf', format='pdf', dpi=200)
plt.show()