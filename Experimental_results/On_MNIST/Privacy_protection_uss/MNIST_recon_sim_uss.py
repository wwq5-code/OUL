...
OUL = [0.556269, 0.565985 , 0.58052, 0.5884143, 0.598428]

OUbLi_w = [0.797470 , 0.7417237 , 0.677023, 0.65852704, 0.64265]

bfu_acc = [0.808246, 0.76499, 0.716, 0.668517, 0.6479]
...
my_y_ticks = np.arange(0.5, 0.91, 0.1)
...
plt.savefig('mnist_recon_sim_uss.pdf', format='pdf', dpi=200)
plt.show()