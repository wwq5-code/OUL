...
OUL = [0.9843, 0.9831 , 0.9830, 0.9825, 0.9828]

OUbLi_w = [0.5805, 0.5355, 0.5373, 0.5370, 0.5272]

bfu_acc =[ 0.9870, 0.9837, 0.9831, 0.9827, 0.9830]

vbu_acc = [0.9893, 0.9893, 0.9893, 0.9893, 0.9893]
...
my_y_ticks = np.arange(97.5, 100.1, 0.5)
...
plt.savefig('mnist_model_acc_uss.pdf', format='pdf', dpi=200)
plt.show()