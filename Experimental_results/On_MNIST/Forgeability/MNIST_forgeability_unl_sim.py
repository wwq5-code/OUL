...
OUL = [ 0.9425174, 0.9423159, 0.9422144, 0.94213384, 0.9420114]
...
my_y_ticks = np.arange(0.94, 0.944, 0.001)
...
plt.savefig('mnist_forgeability_unl_sim.pdf', format='pdf', dpi=200)
plt.show()