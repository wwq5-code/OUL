...
OUL = [0.90355, 0.90316, 0.903996,  0.90417, 0.903994, 0.903994]

org_acc = [0.9958, 0.9975, 0.9983, 0.9967, 0.9942, 0.9972]

vbu_acc = [0.90487, 0.904870, 0.9048707, 0.9048707, 0.9048707, 0.9048707]
...
my_y_ticks = np.arange(0.90, 0.911, 0.002)
...
plt.savefig('mnist_recon_sim_eps.pdf', format='pdf', dpi=200)
plt.show()