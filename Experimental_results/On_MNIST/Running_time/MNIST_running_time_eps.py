...
OUL = [26.78873, 26.1765, 25.18601, 26.84846, 25.3510, 25.3510]

org_acc = [56.627, 58.9688, 54.03780, 52.6078, 52.082422, 52.08242]
...
my_y_ticks = np.arange(10., 90.94, 20.)
...
plt.savefig('mnist_running_time_eps.pdf', format='pdf', dpi=200)
plt.show()