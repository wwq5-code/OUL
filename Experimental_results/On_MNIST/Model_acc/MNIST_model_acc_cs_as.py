...
OUL = [0.9852, 0.9861, 0.9874, 0.9878, 0.9881, 0.9886]

org_acc = [0.9888, 0.9888, 0.9889, 0.9888, 0.9888, 0.9888]

vbu_acc = [0.7869, 0.7869, 0.7869, 0.7869, 0.7869, 0.7869]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.4664, 0.4664, 0.4664, 0.4664, 0.4664, 0.4664]
...
my_y_ticks = np.arange(98., 99.01, 0.2)
...
plt.savefig('mnist_model_acc_cs_as.pdf', format='pdf', dpi=200)
plt.show()