...
OUL = [ 0.9864, 0.9855, 0.9815, 0.9819, 0.9853, 0.9840]

org_acc = [0.9902, 0.9854, 0.9842, 0.9908, 0.9890, 0.9890]

vbu_acc = [0.8774, 0.8349,  0.1979, 0.0958, 0.0892, 0.0892]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc=[0.4664,  0.0892, 0.1010, 0.0958,0.0980, 0.0958 ]
...
plt.legend(loc=(0.33, 0.35),fontsize=20)
plt.tight_layout()
#plt.title("MNIST")
...
plt.savefig('mnist_model_acc_urs.pdf', format='pdf', dpi=200)
plt.show()