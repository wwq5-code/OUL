...
OUL = [0.9752, 0.9814, 0.9787, 0.9773, 0.9771, 0.9767]

org_acc = [0.9854, 0.9854, 0.9854, 0.9854, 0.9854, 0.9854]

vbu_acc = [0.8349, 0.8349, 0.8349, 0.83496, 0.8349, 0.8349]
...
plt.savefig('mnist_model_acc_eps.pdf', format='pdf', dpi=200)
plt.show()