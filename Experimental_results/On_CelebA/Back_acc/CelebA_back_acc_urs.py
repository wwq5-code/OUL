...
OUL = [0.050, 0.0351, 0.0280, 0.038, 0.0388]

org_acc = [0.88, 0.9080, 0.9033, 0.9205, 0.9240]

vbu_acc = [0.0492, 0.0492, 0.0492, 0.0469, 0.0458]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.4592, 0.4120, 0.40115, 0.389, 0.3717]
...
plt.legend(loc=(0.3, 0.475),fontsize=20)
plt.tight_layout()
#plt.title("MNIST")
