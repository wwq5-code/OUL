...
OUL = [0.0522, 0.0891, 0.0994, 0.0953, 0.0973, 0.0993]

org_acc = [0.8586, 0.8586, 0.8586, 0.8586, 0.8586, 0.8586]

vbu_acc = [ 0.0389, 0.0389, 0.0389, 0.0389, 0.0389, 0.0389]
...
plt.savefig('CelebA_back_acc_eps.pdf', format='pdf', dpi=200)
plt.show()