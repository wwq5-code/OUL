...
OUL = [0.9908918, 0.9908791, 0.99087279, 0.990872795, 0.990870286]
...
my_y_ticks = np.arange(0.990, 0.992, 0.0004)
...
plt.savefig('CelebA_forgeability_unl_sim.pdf', format='pdf', dpi=200)
plt.show()