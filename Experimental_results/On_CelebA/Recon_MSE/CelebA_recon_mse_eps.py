...
OUL = [0.091074, 0.09107, 0.09107403, 0.091074, 0.09107, 0.09107]

org_acc = [0.9958, 0.9975, 0.9983, 0.9967, 0.9942, 0.9972]

vbu_acc = [0.0898, 0.0898, 0.0898, 0.0898, 0.0898, 0.0898]
...
plt.savefig('CelebA_recon_mse_eps.pdf', format='pdf', dpi=200)
plt.show()