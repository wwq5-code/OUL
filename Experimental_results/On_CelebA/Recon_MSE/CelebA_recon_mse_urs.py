...
OUL = [ 0.09145, 0.0910740, 0.09003, 0.0885498, 0.09012, 0.09012]

org_acc = [0.9958, 0.9975, 0.9983, 0.9967, 0.9942, 0.9972]

vbu_acc = [0.090817, 0.0898673, 0.09073, 0.08940, 0.08961, 0.08961]
...
my_y_ticks = np.arange(8.8, 9.2, 0.04)
...
plt.savefig('CelebA_recon_mse_urs.pdf', format='pdf', dpi=200)
plt.show()