...
OUL = [0.09035, 0.0910740, 0.089866, 0.0888096, 0.08954, 0.08954]

org_acc = [0.9958, 0.9975, 0.9983, 0.9967, 0.9942, 0.9972]

vbu_acc = [0.08914165, 0.089867, 0.09023, 0.091059, 0.090431, 0.090431]
...
my_y_ticks = np.arange(8.8, 9.8, 0.2)
...
plt.savefig('CelebA_recon_mse_cs_as.pdf', format='pdf', dpi=200)
plt.show()