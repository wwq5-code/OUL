...
OUL = [0.82807, 0.82807, 0.82807, 0.82807, 0.828073]

org_acc = [0.9999, 0.9999, 0.9999, 0.9999, 0.9999]

vbu_acc = [0.9999, 0.9999, 0.9999, 0.99999, 0.99999]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
bfu_acc = [0.830, 0.830, 0.830, 0.830, 0.830]

vbu_ldp_acc = [0.59941, 0.83174, 0.91364, 0.94858, 0.966168]
...
my_y_ticks = np.arange(0.50, 1.01, 0.1)
...
plt.savefig('CelebA_recon_sim_ldp.pdf', format='pdf', dpi=200)
plt.show()