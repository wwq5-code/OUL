...
OUL = [0.82926051, 0.8297285, 0.829681, 0.829126, 0.828073]

org_acc = [0.9999, 0.9999, 0.9999, 0.9999, 0.9999]

vbu_acc = [0.999, 0.999, 0.999, 0.999, 0.999]

#vbu_acc = [0.832142, 0.832611, 0.83258, 0.832074, 0.8310844]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]


vbu_ldp_acc = [0.96546, 0.965589, 0.96574, 0.965940, 0.966168]
...
plt.savefig('CelebA_recon_sim_unl_sim.pdf', format='pdf', dpi=200)
plt.show()