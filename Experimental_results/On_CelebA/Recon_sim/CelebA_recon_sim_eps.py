...
OUL = [0.829584, 0.82958, 0.8295841,  0.829584, 0.829584, 0.829584]

org_acc = [0.9958, 0.9975, 0.9983, 0.9967, 0.9942, 0.9972]

vbu_acc = [0.832922, 0.832922, 0.832922, 0.832922, 0.832922, 0.832922]
...
my_y_ticks = np.arange(0.80, 0.851, 0.01)
...
plt.savefig('CelebA_recon_sim_eps.pdf', format='pdf', dpi=200)
plt.show()