...
OUL = [0.9660, 0.9641, 0.9633, 0.9631, 0.9626]

OUbLi_w = [0.5805, 0.5355, 0.5373, 0.5370, 0.5272]

bfu_acc =[0.9601, 0.9593, 0.9569, 0.9543, 0.9509]

vbu_acc = [0.9661,  0.9661, 0.9661, 0.9661, 0.9661]
...
my_y_ticks = np.arange(95., 97.1, 0.4)
...
plt.savefig('CelebA_model_acc_uss.pdf', format='pdf', dpi=200)
plt.show()