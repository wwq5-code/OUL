...
OUL = [0.77900, 0.79627, 0.81364, 0.8219, 0.8380563682]

OUbLi_w = [0.94858, 0.914890, 0.887353, 0.888389, 0.8736595]

bfu_acc = [0.942929, 0.91580, 0.89970, 0.8819122, 0.86700]
...
my_y_ticks = np.arange(0.75, 1.01, 0.05)
...
plt.savefig('CelebA_recon_sim_uss.pdf', format='pdf', dpi=200)
plt.show()