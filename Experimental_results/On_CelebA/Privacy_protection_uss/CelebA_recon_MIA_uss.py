...
OUL = [0.5040, 0.5000 , 0.5000, 0.5000, 0.5002]

OUbLi_w = [0.5340, 0.5405, 0.5273, 0.5325, 0.5230]

bfu_acc = [0.5970, 0.5830, 0.5843, 0.5707, 0.5708]
...
my_y_ticks = np.arange(0.45, 0.71, 0.05)
...
plt.legend(loc=[0.5,0.6],fontsize=18)
plt.tight_layout()
#plt.title("MNIST")
...
plt.savefig('CelebA_recon_mia_uss.pdf', format='pdf', dpi=200)
plt.show()