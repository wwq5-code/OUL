...
OUL = [1.38804, 1.94799, 2.899695, 4.64808, 3.8247380, 3.82473804]

org_acc = [244.855, 244.855, 244.855, 244.855, 244.8552, 244.855242]
...
my_y_ticks = np.arange(0., 300.94, 60.)
...
plt.savefig('CelebA_running_time_cs_as.pdf', format='pdf', dpi=200)
plt.show()