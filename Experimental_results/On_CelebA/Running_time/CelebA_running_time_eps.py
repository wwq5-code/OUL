...
OUL = [2.152676, 1.9479904, 3.78921, 2.1467646, 2.75458, 2.7545810]

org_acc = [233.070, 233.070, 233.070, 233.070, 233.070, 233.070]
...
my_y_ticks = np.arange(0., 300.94, 100.)
...
plt.savefig('CelebA_running_time_eps.pdf', format='pdf', dpi=200)
plt.show()