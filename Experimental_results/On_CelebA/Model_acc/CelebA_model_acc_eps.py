...
OUL = [0.9495, 0.9233, 0.9101, 0.9156, 0.9146, 0.9146]

org_acc = [0.9572, 0.9572, 0.9572, 0.9572, 0.9572, 0.9572]

vbu_acc = [0.9516,  0.9516, 0.9516, 0.9516, 0.9516, 0.9516]
...
plt.savefig('CelebA_model_acc_eps.pdf', format='pdf', dpi=200)
plt.show()